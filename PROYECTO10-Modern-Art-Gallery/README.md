...
Bienvenido al proyecto **Modern Art Gallery**, una web diseñada para una galeria de arte. Este proyecto está creado únicamente con **HTML** y **CSS**, y tiene como objetivo ofrecer una experiencia visual facil y moderna.
...
1. **Clona el repositorio:**
   ```bash
   git clone https://github.com/AlbertoContento/Modern-Art-Gallery.git
   ```
